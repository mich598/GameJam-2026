const MathRaceGame = {
    ...
    renderShapeDiagram(question) {
        ...
        if (question.shape === "Square") {
            ...
            // scale factor to make the square visually reasonable
            const scale = Math.min(120, question.side * 10);
    ...
    loseGame() {
        ...
        document.getElementById("finalResult").textContent =
            "The police shut the business down.";
    },
...
window.addEventListener("load", () => {
    ...
    if (restartBtn) {
        restartBtn.addEventListener("click", () => MathRaceGame.init());
    }
